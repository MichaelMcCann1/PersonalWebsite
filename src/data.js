export const projects = [
  {
    ImgSrc: "Images/ProjectGrid/paintRight.png",
    title: "PaintRightCincy.com",
    desc: "I designed and developed a website for a new painting company in Cincinnati, OH. The website is an SPA that was created with React and is hosted on Firebase.",
    liveLink: "https://paintrightcincy.com/",
    github: "https://github.com/MichaelMcCann1"
  },
  {
    ImgSrc: "Images/ProjectGrid/scoreboard.png",
    title: "Live Scoreboard",
    desc: "Get the scores of various sports leagues in real time. The data is fetched using ESPN's REST API. Made with React JS and styled with Styled Components.",
    liveLink: "https://mm-livescores.web.app/",
    github: "https://github.com/MichaelMcCann1/LiveScoreboard"
  },
  {
  ...
  },
  {
    ...
    title: "Digital Clock",
    desc: "Digital clock made with ReactJS. The line segments on each digit turn red to create the appearance of a number.",
